...
The deterministic runner (`tools/calib`: CLI, web UI) talks to ONE
host: the master (the VLM harness `tools/calib-agent/app` that shared
this runbook has since been removed).
