...
from ocr_vlm import classifier, glyphs, segment
from ocr_vlm.classifier import (GlyphBank, classify_cell, classify_raster)
...
def test_evaluate_set_holdout_on_synthetic_sets(env):
    ...
    glyphs.build()
    metrics = classifier.evaluate(None, split="set", holdout="s2")
